...
public class BlueSourcePath extends Command {
  /** Creates a new BlueAmpPath. */
  private final DriveSubsystem swerveSubSyetem;
  public BlueSourcePath(DriveSubsystem swerveSubsystem) {
  ...
  public void execute() {
    ...
    Trajectory trajectory = TrajectoryGenerator.generateTrajectory(new Pose2d(0.61, 4.01, new Rotation2d(0)),
      List.of(
        new Translation2d(3.32, 2.90),
        new Translation2d(4.83, 3.63)),
        new Pose2d(3.56, 5.01, Rotation2d.fromDegrees(170.05)),
        trajectoryConfig);
