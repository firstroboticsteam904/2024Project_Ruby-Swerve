...
public class BlueSourceSideAutoScore extends SequentialCommandGroup {
  /** Creates a new BlueAmpSideAutoScore. */
  private final Shooter shooter;
  private final DriveSubsystem swerve;
  public BlueSourceSideAutoScore(Shooter shooter, DriveSubsystem swerve) {
