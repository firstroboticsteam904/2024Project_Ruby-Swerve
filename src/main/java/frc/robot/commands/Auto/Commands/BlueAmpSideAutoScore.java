...
public class BlueAmpSideAutoScore extends SequentialCommandGroup {
  /** Creates a new BlueAmpSideAutoScore. */
  private final Shooter shooter;
  private final DriveSubsystem swerve;
  public BlueAmpSideAutoScore(Shooter shooter, DriveSubsystem swerve) {
